          ...
          <div className="max-w-5xl mx-auto p-8 text-center">
            ...
            <div className="p-8">
              <button
                ...
                className="rounded-lg border border-transparent px-5 py-2.5 text-base font-medium bg-primary text-primary-foreground hover:bg-primary/90 transition-colors"
              >
                count is {count}
              </button>
              <p className="mt-4">
